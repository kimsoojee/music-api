...
VALUES
    ('Popular Album', 'Popular Artist', '15/03/2024', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Another Album', 'Another Artist', '20/06/2024', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
    ('Third Album', 'Third Artist', '10/09/2024', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
